...
const REAL_SPECIES: Record<Rarity, SpeciesSeed[]> = {
  ...
  rare: [
    { name: 'Çiçek Boynuzlu Çiklit', pattern: 'spots', size: 56, bodyH: 0.65, tailShape: 'round', snout: 'hump',
      colors: { body: 0xd6405c, belly: 0xf2a0b0, fin: 0xb8304a, accent: 0xf2d049 },
      desc: 'Alnındaki belirgin hörgücü ve canlı pembe rengiyle özel bir melez çiklit.' },
    { name: 'Tavus Levrek', pattern: 'stripes', size: 64, bodyH: 0.56, tailShape: 'round',
      colors: { body: 0x8a9a4a, belly: 0xd8e0a8, fin: 0x5c6a2a, accent: 0x1a1a1a },
      desc: 'Güçlü yapısı ve göz benekli kuyruğuyla nehirlerin avcısı.' },
    { name: 'Yeşil Terör Çiklit', pattern: 'spots', size: 54, bodyH: 0.58, tailShape: 'round',
      colors: { body: 0x2fae7d, belly: 0x8fdcbc, fin: 0xf2703c, accent: 0xd9502a },
      desc: "Adının aksine akvaryumda görkemli bir turkuaz-yeşil parıltı sunar." },
    { name: 'Oskar Balığı', pattern: 'spots', size: 62, bodyH: 0.6, tailShape: 'round',
      colors: { body: 0x5c3a2a, belly: 0x8a6048, fin: 0x3a241a, accent: 0xd6703f },
      desc: 'Zeki ve etkileşimli yapısıyla akvaryumcuların gözdesi.' },
    { name: 'Severum Çiklit', pattern: 'stripes', size: 50, bodyH: 0.68, tailShape: 'round',
      colors: { body: 0x9a8a3a, belly: 0xd8cf8f, fin: 0x6f6020, accent: 0x4a3f1a },
      desc: 'Altın-yeşil tonlarıyla sakin, iri bir çiklit.' },
    { name: 'Uaru Çiklit', pattern: 'spots', size: 52, bodyH: 0.6, tailShape: 'round',
      colors: { body: 0x6a4a3a, belly: 0x9a7a5c, fin: 0x4a3020, accent: 0x1a1a1a },
      desc: 'Genç halinde çikolata kahvesi lekeleriyle dikkat çeker.' },
    { name: 'Mavi Akara', pattern: 'spots', size: 48, bodyH: 0.54, tailShape: 'round',
      colors: { body: 0x2f8f9a, belly: 0x8fd0d8, fin: 0x1f6a75, accent: 0xf2d049 },
      desc: 'Turkuaz parıltılı pullarıyla Güney Amerika\'nın zarif çikliti.' },
    { name: 'Teksas Çiklit', pattern: 'spots', size: 50, bodyH: 0.6, tailShape: 'round',
      colors: { body: 0x3a8a9a, belly: 0x8fc9d6, fin: 0x2a6070, accent: 0xf2d049 },
      desc: 'İnci gibi parlayan benekli turkuaz pullarıyla tanınır.' },
    { name: 'Papağan Çiklit', pattern: 'none', size: 46, bodyH: 0.62, tailShape: 'round', snout: 'blunt',
      colors: { body: 0x7a8a5c, belly: 0xc7d0a0, fin: 0x5c6a3a, accent: 0xd9b96a },
      desc: 'Papağan gagasını andıran ağzıyla doğal bir çiklit türü.' },
    { name: 'Kan Papağanı Çiklit', pattern: 'none', size: 48, bodyH: 0.75, tailShape: 'round', snout: 'blunt',
      colors: { body: 0xf2503c, belly: 0xffb090, fin: 0xd9301c, accent: 0xff8a5c },
      desc: 'Canlı kırmızı-turuncu yuvarlak gövdesiyle dikkat çekici bir melez.' },
    { name: 'Frontosa Çiklit', pattern: 'stripes', size: 60, bodyH: 0.52, tailShape: 'round', snout: 'hump',
      colors: { body: 0xa8c3d6, belly: 0xe0eef5, fin: 0x5c7a90, accent: 0x2a2a2a },
      desc: "Alnındaki hörgücü ve dik bantlarıyla Tanganyika Gölü'nün asil balığı." },
    { name: 'Malawi Tavus Çiklit', pattern: 'gradient', size: 44, bodyH: 0.44, tailShape: 'round',
      colors: { body: 0x4a5cc9, belly: 0x9aa8ef, fin: 0x2f3aa0, accent: 0xf2d049 },
      desc: "Mor-mavi metalik parıltısıyla Malawi Gölü'nün mücevheri." },
    { name: 'Elektrik Sarı Çiklit', pattern: 'none', size: 40, bodyH: 0.42, tailShape: 'round',
      colors: { body: 0xf2d030, belly: 0xfff2a0, fin: 0xd9b020, accent: 0x1a1a1a },
      desc: 'Parlak sarı gövdesiyle akvaryumda güneş gibi parlar.' },
    { name: 'Venustus Çiklit', pattern: 'spots', size: 56, bodyH: 0.46, tailShape: 'round',
      colors: { body: 0xe0c26a, belly: 0xf5e6b8, fin: 0x3a5c9a, accent: 0x2a2a2a },
      desc: 'Mavi yüzü ve kumlu altın gövdesiyle görkemli bir Malawi çikliti.' },
    { name: 'Kızıl İmparatoriçe Çiklit', pattern: 'gradient', size: 48, bodyH: 0.5, tailShape: 'round',
      colors: { body: 0xf2703c, belly: 0xffc79a, fin: 0x3a6ea8, accent: 0xd9502a },
      desc: 'Alev kırmızısından maviye geçen gövde rengiyle olağanüstü bir çiklit.' },
    { name: 'Tropheus Duboisi', pattern: 'stripes', size: 42, bodyH: 0.58, tailShape: 'round',
      ...
      desc: "Jet siyahı gövdesindeki beyaz bandıyla Tanganyika Gölü'nün klasiği." },
    { name: 'Kaplan Oskar', pattern: 'spots', size: 62, bodyH: 0.6, tailShape: 'round',
      colors: { body: 0xd97a1f, belly: 0xf2c78a, fin: 0x8a4a10, accent: 0x1a1a1a },
      desc: 'Turuncu-siyah kaplan desenli, karizmatik bir Oskar varyetesi.' },
  ],
  epic: [
    { name: 'Mavi Cerrah Balığı', pattern: 'gradient', size: 50, bodyH: 0.65, tailShape: 'lunate',
      colors: { body: 0x1f5cc9, belly: 0x6a9aef, fin: 0xf2d030, accent: 0x1a1a1a },
      desc: "Okyanusun en tanınan mavi-sarı desenli yıldızı." },
    { name: 'Sarı Cerrah Balığı', pattern: 'none', size: 42, bodyH: 0.75, tailShape: 'lunate',
      colors: { body: 0xf2c916, belly: 0xfff2a0, fin: 0xd9a80f, accent: 0xffffff },
      desc: 'Resiflerde parlayan saf sarı gövdesiyle ünlü.' },
    { name: 'İmparator Melek Balığı', pattern: 'hstripe', size: 52, bodyH: 0.75, tailShape: 'round',
      colors: { body: 0x1f5c9a, belly: 0x4a8fc9, fin: 0xf2c916, accent: 0xffffff },
      desc: 'Yetişkinlikte kazandığı mavi-sarı şeritleriyle resifin asil sakini.' },
    { name: 'Kraliçe Melek Balığı', pattern: 'gradient', size: 54, bodyH: 0.78, tailShape: 'round',
      colors: { body: 0x2f9ac9, belly: 0x6ac0e0, fin: 0xf2c916, accent: 0x1a1a1a },
      desc: 'Başındaki taç desenli benekle adını hak eder.' },
    { name: 'Mağribi Put Balığı', pattern: 'stripes', size: 48, finScale: 1.6, tailShape: 'lunate', dorsalStyle: 'flowing',
      colors: { body: 0xf2e9d0, belly: 0xffffff, fin: 0x1a1a1a, accent: 0xf2c916 },
      desc: 'Uzun sırt yüzgeci ve bant desenleriyle resiflerin sembolü.' },
    { name: 'Picasso Balistesi', pattern: 'stripes', size: 46, spiky: true, tailShape: 'round',
      colors: { body: 0xd9c98a, belly: 0xf2e9c0, fin: 0x1a1a1a, accent: 0x3a6ea8 },
      desc: 'Geometrik çok renkli deseniyle sanki fırçayla boyanmış gibidir.' },
    { name: 'Toz Mavisi Cerrah', pattern: 'gradient', size: 46, bodyH: 0.68, tailShape: 'lunate',
      colors: { body: 0x5ca8e0, belly: 0xa8d8f2, fin: 0xf2c916, accent: 0x1a1a1a },
      desc: 'Pudra mavisi gövdesi ve sarı sırt yüzgeciyle şıklığın simgesi.' },
    { name: 'Tilki Yüz Tavşan Balığı', pattern: 'spots', size: 44, spiky: true, tailShape: 'round', snout: 'long',
      colors: { body: 0xf2d030, belly: 0xfff2a0, fin: 0xd9b020, accent: 0x3a2a1a },
      desc: 'Zehirli dikenlerine rağmen sakin huylu, tilkiyi andıran yüzlü bir tür.' },
    { name: 'Arlekin Diş Balığı', pattern: 'gradient', size: 48, tailShape: 'round',
      colors: { body: 0xf2703c, belly: 0xffb090, fin: 0x3a6ea8, accent: 0xd9502a },
      desc: 'Canlı turuncu-mavi renk geçişleriyle resifin nadide dişlisi.' },
