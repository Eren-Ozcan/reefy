...
const TR: Record<string, string> = {
  ...
  'You already own this — restored. ✓': 'Bu ürüne zaten sahipsin — geri yüklendi. ✓',
  '🧾 Restore purchases': '🧾 Satın alımları geri yükle',
  'Restore': 'Geri yükle',
  'Brings back Remove Ads if you bought it on this store account — after a reinstall or on a new phone.':
    "Reklamları Kaldır'ı bu mağaza hesabıyla aldıysan geri getirir — uygulamayı yeniden kurduğunda ya da yeni telefonda.",
  'Checking your purchases…': 'Satın alımların kontrol ediliyor…',
  'Purchases restored. ✓': 'Satın alımlar geri yüklendi. ✓',
  'No purchases found on this account.': 'Bu hesapta satın alım bulunamadı.',
  "Couldn't restore: {err}": 'Geri yüklenemedi: {err}',
  ...
  '🏆 Global ranking': '🏆 Küresel sıralama',
  'The global leaderboard is only available in the Google Play build.': 'Küresel sıralama yalnızca Google Play sürümünde çalışır.',
  'Sign in to Google Play Games first, from Settings.': "Önce Ayarlar'dan Google Play Games'e giriş yap.",
  '🧹 The glass is dirty — tap the spots to scrub them off.': '🧹 Cam kirli — lekelere dokunarak temizle.',
  ...
  'all fed': 'hepsi tok',
  '{n} decor': '{n} dekor',
  'Tap the dirt on the glass to scrub it off.': 'Camdaki kirin üzerine dokunarak temizle.',
  'The glass is spotless. ✨': 'Cam tertemiz. ✨',
  '🦪 Earn 5 pearls<br/><b>{n} left today</b>': '🦪 5 inci kazan<br/><b>bugün {n} hakkın var</b>',
  'Back tomorrow': 'Yarın gel',
  "That's all the ads for today — come back tomorrow.": 'Bugünlük reklam hakkın doldu, yarın tekrar gel.',
